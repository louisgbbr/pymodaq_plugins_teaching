...
class DAQ_0DViewer_Photospectro(DAQ_Viewer_base):
...
#        elif ...
    ...
    def grab_data(self, Naverage=1, **kwargs):
        ...
        self.dte_signal.emit(DataToExport(name='Photospectro',
                                          data=[DataFromPlugins(name='Photodiode', data=[data_tot],labels=['intensity'],units='V')]))
